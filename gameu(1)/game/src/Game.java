    ...
    public void initialize() {
        player.setInteraction(new Interaction() {
            ...
            public void moveroom(Exit exit) {
                ...
                player.setLocation(exit.getEnterPoint());
                player.AdjustPosition(exit.getEnterPoint(),camera.getXViewport(),camera.getYViewport(),rooms.get(currentRoom).getImage().getWidth(),rooms.get(currentRoom).getImage().getHeight());
...
//        });
    ...
    public void gamevalue() {
        player = new Player("(baka).jpg",70,100);
        rooms.add(new Room("map.png",new Rectangle(0,0,1000,700),new Point(500,350)));
