...
public class Room {
    ...
    public void addAsset(Asset asset, int layer) {
        ...
        assets.add(asset);
        if(layer == 0) image.getGraphics().drawImage(asset.getImage(),asset.getSize().x,asset.getSize().y,asset.getSize().width,asset.getSize().height,null);
        else this.layer.get(layer).getGraphics().drawImage(asset.getImage(),asset.getSize().x,asset.getSize().y,asset.getSize().width,asset.getSize().height,null);
    }
