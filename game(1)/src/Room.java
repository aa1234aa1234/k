...
public class Room {
    ...
    public void addAsset(Asset asset, int layer) {
        ...
        asset.getCollision().y -= asset.getCollision().height/2.0;
        assets.add(asset);
        if(layer == 0) image.getGraphics().drawImage(asset.getImage(),asset.getCollision().x,asset.getCollision().y,asset.getCollision().width,asset.getCollision().height,null);
        else this.layer.get(layer).getGraphics().drawImage(asset.getImage(),asset.getCollision().x,asset.getCollision().y,asset.getCollision().width,asset.getCollision().height,null);
    }
