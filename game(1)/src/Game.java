    ...
    public void initialize() {
        ...
        gamepanel.setRender(new IRender() {
            ...
            public void render(Graphics2D graphics2D) {
                ...
                for(BufferedImage a : rooms.get(currentRoom).getLayer()) {
                    graphics2D.drawImage(a,getImageXStart(),getImageYStart(),getImageXEnd(),getImageYEnd(),getXViewPortStart(),getYViewPortStart(),getXViewPortEnd(),getYViewPortEnd(),null);
                }
            }
        });
