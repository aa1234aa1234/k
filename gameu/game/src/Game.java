    ...
    public void initialize() {
        ...
        gamepanel.setRender(new IRender() {
            ...
            public void render(Graphics2D graphics2D) {
                ...
                graphics2D.drawImage(rooms.get(currentRoom).getImage(),0,0,1000,700,getXViewPortStart(),getYViewPortStart(),getXViewPortEnd(),getYViewPortEnd(),null);
                graphics2D.drawImage(player.getImage(),player.getPosition().x-35,player.getPosition().y-50,70,100,null);
            }
        });
...
//        });
    ...
    public void gamevalue() {
        player = new Player("(baka).jpg");
        rooms.add(new Room("map.png",new Rectangle(0,0,1000,700),new Point(100,350)));
        ...
        mainthread = new Thread(new Runnable() {
            ...
            public void run() {
                while(true) {
                    ...
                    player.move(keydown.isLeft(),keydown.isRight(),keydown.isUp(),keydown.isBottom(),getXViewPortStart(),getYViewPortStart(),getXViewPortEnd(),getYViewPortEnd(),rooms.get(currentRoom).getImage().getWidth(),rooms.get(currentRoom).getImage().getHeight(),camera);
