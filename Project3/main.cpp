...
int main(void)
{
    ...
    ModelImporter* importer = new ModelImporter("models/spider.obj");
    unsigned int vbo, vao, ebo;
    Shader objectshader = Shader("vertexshader.glsl", "fragmentshader.glsl");
    glGenBuffers(1, &vbo);
    ...
    std::vector<Texture> lol;
    lol.push_back(Texture("diffuse"));
    lol[0].setId(framebuffer.getFrameTexture());
    Mesh mesh(idkaa, waaa, lol);
