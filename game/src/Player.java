...
public class Player {
    ...
    public void AdjustPosition(Point location, int imageWidth, int imageHeight, int XViewPort, int YViewPort) {
        ...
        if(location.y-XViewPort > 0 && location.y+XViewPort < imageWidth) y = 350;
        else if((location.y-XViewPort <= 0 && location.y+XViewPort >= imageWidth) || (location.y-XViewPort <= 0 && location.y+XViewPort < imageWidth)) y = location.y;
        else if(location.y-XViewPort > 0 && location.y+XViewPort >= imageWidth) y = location.y-(imageWidth-XViewPort*2);
