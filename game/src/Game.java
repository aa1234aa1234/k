...
public class Game extends JFrame {
    ...
    public void gamevalue() throws IOException {
        ...
        loadAssetJson();
//        rooms.get(0).addAsset(new Asset(315,250,350,120,"assets/house.png"),1);
//        rooms.get(2).addAsset(new Asset(70,100,500,350,"player_sprites/(baka).png"),1);
        for(Room e : rooms) {
            e.loadAssets();
        }
        ...
        dialogBox.printText("* skibidi toilet");
        dialogBox.printText("* even more skibidi");
        dialogBox.printText("* aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
